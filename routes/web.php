...
|        | GET|HEAD  | api/sewa                         | sewa.index                      | App\Http\Controllers\API\SewaController@index                                   | api                                                       |
|        | POST      | api/sewa                         | sewa.store                      | App\Http\Controllers\API\SewaController@store                                   | api                                                       |
|        | GET|HEAD  | api/sewa/create                  | sewa.create                     | App\Http\Controllers\API\SewaController@create                                  | api                                                       |
|        | GET|HEAD  | api/sewa/{sewa}                  | sewa.show                       | App\Http\Controllers\API\SewaController@show                                    | api                                                       |
|        | PUT|PATCH | api/sewa/{sewa}                  | sewa.update                     | App\Http\Controllers\API\SewaController@update                                  | api                                                       |
|        | DELETE    | api/sewa/{sewa}                  | sewa.destroy                    | App\Http\Controllers\API\SewaController@destroy                                 | api                                                       |
|        | GET|HEAD  | api/sewa/{sewa}/edit             | sewa.edit                       | App\Http\Controllers\API\SewaController@edit                                    | api                                                       |
